...
# usage:
# env GANGA_GRID_SIMULATOR=1 ganga -o[LCG]GLITE_ENABLE=True -oGLITE_SETUP=/dev/null -o[PollThread]autostart=True simulator.py

# when the simulator is enabled it will produce data files in the current working directory
# these files may be further processed with the simulator-analyze.py script to extract timing data
