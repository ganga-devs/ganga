...
from GangaCore.GPIDev.Base.Objects import GangaObject, Node
from GangaCore.GPIDev.Base.Filters import allComponentFilters
from GangaCore.GPIDev.Base.Proxy import isProxy, addProxy, isType, getProxyAttr, stripProxy, TypeMismatchError, ReadOnlyObjectError, getName
...
class GangaList(GangaObject):
    ...
    _exportmethods = ['__add__', '__contains__', '__delitem__', '__delslice__', '__eq__', '__ge__',
                      '__getitem__','__class_getitem__', '__getslice__', '__gt__', '__iadd__', '__imul__',
    ...
    def _export___class_getitem__(cls, *args, **kwargs):
        return addProxy(self.__class_getitem__(cls, *args, **kwargs))
