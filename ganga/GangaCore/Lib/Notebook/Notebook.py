    ...
    _schema = Schema(
            ...
            0),
        {
            ...
            'kernel': SimpleItem(
                preparable=1,
                defvalue='python2',
                doc="The kernel to use for the notebook execution. Depending on configuration, python3, Root and R might be available."),
            'regexp': SimpleItem(
                preparable=1,
                defvalue=[r'.+\.ipynb$'],
                typelist=["str"],
...
class NotebookRTHandler(IRuntimeHandler):
    ...
    def prepare(self, app, appconfig, appmasterconfig, jobmasterconfig):
        ...
        return StandardJobConfig(
            'python', None, ['notebook_wrapper_generated.py'], None, None, [
