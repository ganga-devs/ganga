...
from GangaCore.Lib.LCG.Utility import get_md5sum
from GangaCore.Lib.LCG.ElapsedTimeProfiler import ElapsedTimeProfiler

from GangaCore.Lib.LCG import Grid
from GangaCore.Lib.LCG.GridftpSandboxCache import GridftpSandboxCache
...
#       prepare input/output sandboxes
        ...
        if self.xRSLextras:
            for key in list(self.xRSLextras.keys()):
                if key in list(xrsl.keys()):
