...
class TestMassStorageWN(GangaUnitTest):
    ...
    def test_a_Submit(self):
        ...
        j.outputfiles = [
            MassStorageFile(
                namePattern='*' + _ext,
                outputfilenameformat=self.standardFormat)]
        j.submit()
    ...
    def test_c_SplitJob(self):
        ...
        MassStorageFile = self.fileClass
        from GangaCore.GPI import Job, LocalFile, ArgSplitter
        ...
        j.outputfiles = [
            MassStorageFile(
                namePattern='*' + _ext,
                outputfilenameformat=self.extendedFormat)]
        j.submit()
    ...
    def test_g_MultipleFiles(self):
        ...
        j.outputfiles = [
            MassStorageFile(
                namePattern='*' + _ext,
                outputfilenameformat=self.customOutputFormat)]
