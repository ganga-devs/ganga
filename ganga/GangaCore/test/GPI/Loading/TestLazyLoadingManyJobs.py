...
class TestLazyLoadingManyJobs(GangaUnitTest):
    ...
    def setUp(self):
        ...
        super(TestLazyLoadingManyJobs, self).setUp(extra_opts=extra_opts)
    ...
    def test_b_JobNotLoaded(self):
        ...
        from GangaCore.GPIDev.Lib.Job.Job import lazyLoadJobApplication, lazyLoadJobBackend, lazyLoadJobStatus, lazyLoadJobFQID
