...
""")
    ...
    def test_d_RunningExecutables(self):
        from GangaCore.GPI import Job, File, Executable
    ...
    def test_e_UsingDifferentBackends(self):
        from GangaCore.GPI import Job, plugins, Local
    ...
    def test_f_InputAndOutputData(self):
        from GangaCore.GPI import Job, File, LocalFile, GangaDataset, Local, plugins
    ...
    def test_g_Splitters(self):
        from GangaCore.GPI import Job, GenericSplitter, GangaDataset, GangaDatasetSplitter, LocalFile
    ...
    def test_h_PostProcessors(self):
        ...
        from GangaCore.GPI import Job, RootMerger, TextMerger, CustomMerger, SmartMerger, RootFileChecker, FileChecker, \
    ...
    def test_i_MiscellaneousFunctionality(self):
        from GangaCore.GPI import JobTemplate, Local, Job, templates, jobtree
    ...
    def test_j_Queues(self):
        from GangaCore.GPI import queues, Job, GenericSplitter
    ...
    def test_k_Tasks(self):
        from GangaCore.GPI import CoreTask, CoreTransform, Executable, Local, GenericSplitter, LocalFile, GangaDataset, \
        ...
        # -- TASKS OPTIONS START
        # note - done at the transform level rather than task level as different
        # backends may not need it
