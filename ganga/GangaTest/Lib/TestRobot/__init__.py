...
config.addOption('TestPairs', [['Ganga/old_test', 'Local', 'local'], ['GangaLHCb/old_test',
                 'Local', 'local']], 'These are the tests to perform, the backend, and the configuration')
...
config.addOption('EmailOnStartup', 'False',
