...
config = GangaCore.Utility.Config.makeConfig(
    'TestRobot', 'Parameters for the autonomous independent testing of Ganga')

config.addOption('ReleasePath', 'http://cern/ch/ganga/download/',
...
config.addOption('TestPairs',
                 [['Ganga/old_test',
                  ...
                  ['GangaLHCb/old_test',
                   'Local',
                   'local']],
                 'These are the tests to perform, the backend, and the configuration')
...
config.addOption('PublishPath', '~/public_html/testrobot',
                 'Directory where test results should be made available as a .tgz file')
