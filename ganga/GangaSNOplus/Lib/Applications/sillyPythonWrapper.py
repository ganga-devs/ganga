...
def run_script_lcg(script_name, args):
    ...
    script = 'source $VO_SNOPLUS_SNOLAB_CA_SW_DIR/sl' + \
        str(version) + '/env_cvmfs.sh\n'
    ...
    # As long as the python command is the final one, the exception raising
    # should work!
...
if __name__ == '__main__':
    ...
    parser.add_option('-l', type='string', dest='location',
                      help='where am i running (lcg/wg)')
    parser.add_option('-f', type='string', dest='env_file',
                      help='send a file with the appropriate environment')
