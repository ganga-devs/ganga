...
class TRExPlusOAAnalysis(IPrepareApp):
    ...
    _schema = Schema(
            ...
            1),
        {
            ...
            'oaana_only': SimpleItem(
                defvalue=False,
                doc='Run only oaAnalysis on the input files, i.e. skip the reconstruction.',
                typelist=['bool']),
            'oaana_args': SimpleItem(
                defvalue=[],
                typelist=[
                    'str',
                    'GangaCore.GPIDev.Lib.File.File.File',
            ...
            'filenamesubstr': SimpleItem(
                defvalue=None,
                doc='This string will be substituted by "trex" in the TREx output filename and "anal" in the oaAnalysis output filename.',
                typelist=[
                    'str',
                    'type(None)']),
            'env': SimpleItem(
