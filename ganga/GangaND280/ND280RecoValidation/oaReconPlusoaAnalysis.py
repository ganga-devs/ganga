...
class oaReconPlusoaAnalysis(IPrepareApp):
    ...
    _schema = Schema(
            ...
            1),
        {
            ...
            'filenamesubstr': SimpleItem(
                defvalue=None,
                doc='This string will be substituted by recnewstr variable in the reco output filename and analnewstr variable in the oaAnalysis output filename.',
                typelist=[
                    'str',
                    'type(None)']),
            'reconewstr': SimpleItem(
                ...
                typelist=['str']),
            'analnewstr': SimpleItem(
                defvalue='validtree',
                doc='This string will substitute filenamesubstr in the input filename to create the oaAnalysis output filename.',
                typelist=['str']),
            'env': SimpleItem(
                defvalue={},
                typelist=['str'],
    ...
    def configure(self, masterappconfig):
        ...
        if self.filenamesubstr is None:
            ...
            anal_outputfile = firstFile.replace(
                self.filenamesubstr, self.analnewstr)
