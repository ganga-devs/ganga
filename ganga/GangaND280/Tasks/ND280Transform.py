...
from GangaND280.ND280Splitter import splitNbInputFile
                ...
                if not inc_file_mask:
                    for f in job.outputfiles:
                        ...
                        try:
                            ...
                            inputdir = '/'.join([os.path.expanduser(os.path.expandvars(getConfig('Output')['SharedFile']
                                                ['uploadOptions']['path'])), f.outputfilenameformat.replace('{fname}', '')])
