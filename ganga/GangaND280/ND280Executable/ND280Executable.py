...
class ND280Executable(IPrepareApp):
    ...
    def configure(self, masterappconfig):
        ...
        if self.outputfile is None:
            ...
            if isinstance(self.outputfile, type([])):
        ...
        # So get the list of filenames get_dataset_filenames() and create a file
        # containing the list of files and put it in the sandbox
