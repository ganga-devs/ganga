...
class TestDataFiles(GangaUnitTest):
    ...
    def testDataFiles(self):
        ...
        # not sure if this should raise an exception or not. The original test had a try..except
        # that would always
        # pass so not sure :)
    ...
    def testDataFilesExternal(self):
        ...
        # Methods
        lfn = DiracFile(
            lfn='/lhcb/LHCb/Collision16/DIMUON.DST/00053485/0000/00053485_00000424_1.dimuon.dst')
