...
class TestDatasets(GangaUnitTest):
    ...
    def testCompressedDatasetsFunctions(self):
        ...
        ds3 = ds1.union(ds2)
        assert len(ds3) == 4
        assert sorted(ds3.getLFNs()) == ['/otherpath/to/some/file/c', '/path/to/some/file/a',
                                         '/path/to/some/otherfile/b', '/path/to/some/otherfile/d']
        ...
        ds1.extend(ds2)
        assert len(ds1) == 4
        assert ds1.getLFNs() == ['/path/to/some/file/a', '/path/to/some/otherfile/b',
                                 '/otherpath/to/some/file/c', '/path/to/some/otherfile/d']
