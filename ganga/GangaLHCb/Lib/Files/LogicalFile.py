    ...
    _schema = Schema(
            ...
            0),
        {
            ...
            'localDir': SimpleItem(
                ...
                transient=1),
            'remoteDir': SimpleItem(
                defvalue="",
                doc='remote directory where the LFN is to be placed in the dirac base directory by '
                    'the put method.',
                transient=1),
            ...
            'guid': SimpleItem(
                ...
                copyable=1,
                typelist=['str'],
                doc='return the GUID/set the GUID to use if not using wildcards in the '
                    'namePattern.',
                transient=1),
...
#       only be used for backwards compatability to load old jobs
    ...
    def __init__(self, name=""):
        ...
        logger.warning("!!! LogicalFile has been deprecated, this is now just a wrapper to the "
                       "DiracFile object")
