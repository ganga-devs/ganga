...
async def css(request):
    content = open(os.path.join(ROOT, 'static', 'templates', 'base16-eighties-dark.css'), 'r').read()
...
if __name__ == '__main__':
    ...
    app = web.Application()
    app.router.add_get('templates/cli2.html', index)
    app.router.add_get('templates/base16-eighties-dark.css', css)
    app.router.add_get('js/webrtcterm.js', javascript)
