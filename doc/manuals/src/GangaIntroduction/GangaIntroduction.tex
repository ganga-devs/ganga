...
with setting up jobs that run the main \LHCb applications, all of
...
For detailed setup and installation procedure for \LHCb see \url{http://cern.ch/ganga/user}.
...
(like Athena jobs for \davinci jobs for \lhcb) so only a few general
...
# some packages such as GangaLHCb may be taken from the release area
# Examples:
#RUNTIME_PATH = GangaLHCb
:
:
#=======================================================================
[Logging]
...
The \LHCb extensions are implemented as plugins to the \ganga core
