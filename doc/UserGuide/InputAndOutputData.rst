...
This will upload the local file "~/temp/mydata.txt" to the user's Google Drive. The File object also supports for glob patterns, which can be supplied as `j.namePattern = '*.ROOT'`.
