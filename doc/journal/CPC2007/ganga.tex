...
%ADD RELEASE PROCESS?
%ADD SSH?
%ADD DIANE reference for low latency
%ADD GUI?
...
%gLite/EGEE/WLCG \cite{LCG}, ARC/NorduGrid~\cite{NorduGrid} and OSG~\cite{OSG}. 
...
phases of the project, in particular Pere Mato, Craig Tull, Wim
Lavrijsen, David Adams, Janusz Martyniak, Ruth Dixon del Tufo, David
Tuckett, Rebecca Ronke, Vladimir Romanovski and Mike Williams.
...
%%%\bibitem{VOMS} TODO
%%%
%%%\bibitem{AFS} Andrew File System, http://www.openafs.org
%%%\bibitem{Kerberos} Kerberos Consortium, http://www.kerberos.org
%%%
%%%\bibitem{RooFit} W. Verkerke, D. Kirkby, ``The RooFit toolkit for data modeling'',
...
%%%
%%%\bibitem{NorduGrid} http://www.nordugrid.org
%%%
...
%%%
%%%\bibitem{Geant4}J.Allison et al., Geant 4 - a simulation toolkit, Nuclear Instruments 
