...
from GangaAtlas.Lib.ATLASDataset.DQ2Dataset import isDQ2SRMSite, getIncompleteLocationsCE, getIncompleteLocations, whichCloud
...
#       prepare inputdata
        ...
        if job.inputdata:
            ...
            # DQ2Dataset and ATLASLocalDataset job splitting is done in AthenaSplitterJob
