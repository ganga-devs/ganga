...
disp_config.addOption('jobs_columns_functions',
                 {'subjobs': "lambda j: len(j.subjobs)", 'application': "lambda j: j.application.__class__._name",
                  'backend': "lambda j:j.backend.__class__._name", 'comment': "lambda j: j.comment"},
