...
class Grid(object):
    ...
    def __get_default_lfc__():
        ...
        output = Grid.wrap_lcg_infosites('lfc')
...
#       if the <jid_hash> is found in the path of outdir.
    ...
    def cream_submit(jdlpath, ce, delid, cred_req):
        ...
        delid = Grid.cream_proxy_delegation(ce, delid, cred_req)
    ...
    def arc_submit(jdlpath, ce, verbose, cred_req):
        ...
        cmd = 'arcsub %s -S org.nordugrid.gridftpjob -j %s' % (Grid.__arc_get_config_file_arg__(), tmpstr)
        exec_bin = True
