...
class Executable(IPrepareApp):
    ...
    _schema = Schema(Version(2,0), {
        ...
        'is_prepared' : SimpleItem(defvalue=None, strict_sequence=0, visitable=1, copyable=1, typelist=['type(None)','bool','Ganga.GPIDev.Lib.File.File.ShareDir'],protected=0,comparable=1,doc='Location of shared resources. Presence of this attribute implies the application has been prepared.')
        } )
