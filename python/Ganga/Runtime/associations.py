...
config = makeConfig( "File_Associations", 'Default associations between file types and file-viewing commands.\
 The name identifies the extension and the value the commans.\
 New extensions can be added.\
 A single & after the command indicates that the process will be started in the background.\
 A && after the command indicates that a new terminal will be opened and the command executed in that terminal.' , is_open=True)
