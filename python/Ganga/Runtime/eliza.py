    ...
    def respond(self, str):
        ...
        for i in range(0, len(self.keys)):
            ...
            if match:
                ...
                # we've got a response... stuff in reflected text where
                # indicated
...
gPats = [
    ...
    # OK, lets add a few ganga specific keywords so we can have some fun
    # Needs to be really extened to include som god questions. -- Andrew
    [r'(.*)submit(.*)',
        ["Why do you want to submit?",
         "Does submitting give you pleasure?",
         "Did you ever try an alternative to submitting?"]],
    ...
    [r'(.*)Ganga(.*)',
        ["Are you a reborn Indian?",
         "Is your interest in the Ganges river related to Indian cuisine?"]],

    [r'(.*)backend(.*)',
        ["Why not use a frontend?",
         "Has it anything to do with your father?"]],

    [r'(.*)Dial(.*)',
        ["Why don't you give me your number?",
         "Am I your interactive help or your date?",
         "Why not try to call the helpdesk?"]],

    [r'(.*)Dirac(.*)',
        ["Why do you want to talk about a dead physicist?",
         "Do you feel preasure, because you are expected to win a Nobel prize?",
         "Are you interested in science?"]],

    [r'help',
        ["Do you think this help is not useful?",
         "Is this a cry for help?",
         "Why don't you try to be more verbose?"]],
...
# Revision 1.3  2007/01/25 15:52:39  moscicki
# mergefrom_Ganga-4-2-2-bugfix-branch_25Jan07 (GangaBase-4-14)
#
# Revision 1.2.4.1  2007/01/22 14:20:10  moscicki
# removed deprecated whrandom module
#
# Revision 1.2  2005/08/31 15:21:15  andrew
# More help
#
#
#
