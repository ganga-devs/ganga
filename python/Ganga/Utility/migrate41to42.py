...
def JobCheckForV41():
   ...
   if len(jobsv41ready):
      log.warning("Job(s) %s were created in (uncompatible) version 4.1 "%jobsv41ready)
   ...
   if len(jobsv41notready):
      log.warning("Job(s) %s were created in (compatible) version 4.1, but not ready for conversion"%jobsv41notready)
