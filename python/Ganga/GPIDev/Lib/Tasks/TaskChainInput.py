...
class TaskChainInput(Dataset):
    ...
    _schema = Schema(Version(1, 0), {
        ...
        'include_file_mask': SimpleItem(defvalue=GangaList(), typelist=['str'], sequence=1, doc='List of Regular expressions of which files to include for input'),
        'exclude_file_mask': SimpleItem(defvalue=GangaList(), typelist=['str'], sequence=1, doc='List of Regular expressions of which files to exclude for input'),
    })
