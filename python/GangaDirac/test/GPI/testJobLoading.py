...
from GangaCore.GPIDev.Base.Proxy import stripProxy, GPIProxyClassFactory, setProxyInterface
...
def removeClassFromGPI(class_):
    ...
    del GangaCore.GPI.__dict__[_getName(class_)]
...
class TestJobMigration(object):
    ...
    def test_b_JobLoads(self):
        ...
        from GangaCore.GPI import jobs, Dirac
