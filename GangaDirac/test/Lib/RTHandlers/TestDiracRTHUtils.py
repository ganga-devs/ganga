...
class TestDiracRTHUtils(GangaGPITestCase):
    ...
    def test_API_nullifier(self):
        self.assertEqual(API_nullifier(None),None,"Didn't return None for None input ")
        self.assertEqual(API_nullifier([]),None,"Didn't return None for empty list input")
        self.assertEqual(API_nullifier([12]),[12],"Didn't return [12] for [12] input")
        self.assertEqual(API_nullifier(['str']),['str'],"Didn't return ['str'] for ['str'] input")
